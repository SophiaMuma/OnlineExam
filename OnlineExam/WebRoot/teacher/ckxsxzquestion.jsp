...
<html>
  ...
  <body>
    ...
    <div class="divtitle2">
    	<form action="${pageContext.request.contextPath }/question_addQuestionXZSX.action?qtid=1&tid=<s:property value="#session.existTeacher.tid" />" target="mainFrame" method="post">
    		...
    		<input type="submit" value="确定添加试题"/>&nbsp;&nbsp;&nbsp;&nbsp;
    		<a href="${pageContext.request.contextPath }/question_addQuestionXZ.action">重新添加试题</a>
    	</form>
