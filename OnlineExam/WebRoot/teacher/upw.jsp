...
<html>
  ...
  <body>
  	...
  	<div id="div1">
   		<form id="form1" action="${pageContext.request.contextPath }/teacher_updatePW.action?tid=<s:property value="#session.existTeacher.tid"/>" method="post" target="mainFrame" onsubmit="return checkForm('<s:property value="#session.existTeacher.password" />')">
   			<table>
   				<tr>
