    	...
    	<div id="div2">
    			<table>
    				...
    				<tr>
    					...
    					<td style="text-align: left;">
    						<input readonly="readonly" id="qanswer" name="qanswer" type="text" value="<s:property value="questionxx.qanswer"/>"/>
    					</td>
    				</tr>
    				<tr>
    				...
    				<tr>
    					...
    					<td style="text-align: left;">
    						...
    						<span readonly="readonly" id="owordspan">* 关键字表示该试题所考察的知识点</span>
    					</td>
    				</tr>
    				<tr>
