  	  ...
  	  <div id="div2">
   		<table border="0px" cellspacing="0px">
   			...
   			<s:iterator value="pageBean.list" var="q">
   			  <tr>
   			  	...
   			  	<td><a href="${pageContext.request.contextPath }/question_ckQuestionXX.action?qid=<s:property value="#q.qid"/>">查看</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath }/question_delQuestion.action?qid=<s:property value="#q.qid"/>">删除</a></td>
   			  </tr>
   			</s:iterator>
   		</table>
   		<div class="pagediv">
   		<s:if test="pageBean.list != null">
   			...
   			<s:if test="pageBean.page != 1">
   				<a href="${pageContext.request.contextPath }/question_ckQuestion.action?tid=<s:property value="#session.existTeacher.tid" />&page=<s:property value="pageBean.page-1"/>&qid=<s:property value="pageBean.list[0].qid"/>&qtid=<s:property value="pageqtid"/>">&nbsp;上一页&nbsp;</a>
   			</s:if>
   			...
   			<s:if test="pageBean.page != pageBean.totalPage">
   				<a href="${pageContext.request.contextPath }/question_ckQuestion.action?tid=<s:property value="#session.existTeacher.tid" />&page=<s:property value="pageBean.page+1"/>&qid=<s:property value="pageBean.list[0].qid"/>&qtid=<s:property value="pageqtid"/>">&nbsp;下一页</a>
   			</s:if>
   		</s:if>
   		</div>
   		</div>
